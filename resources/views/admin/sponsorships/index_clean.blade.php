                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center justify-center space-x-2">
                                                ...
                                                @if($sponsorship->status === 'pending')
                                                    <button onclick="confirmApproveSponsor({{ $sponsorship->id }}, '{{ $sponsorship->company_name }}')" 
                                                    ...
                                                    <button onclick="confirmRejectSponsor({{ $sponsorship->id }}, '{{ $sponsorship->company_name }}')" 
                                                ...
                                                @elseif($sponsorship->status === 'approved')
                                                    <button onclick="confirmActivateSponsor({{ $sponsorship->id }}, '{{ $sponsorship->company_name }}')" 
                                                ...
                                                @elseif($sponsorship->status === 'active')
                                                    <button onclick="confirmCompleteSponsor({{ $sponsorship->id }}, '{{ $sponsorship->company_name }}')" 
...
<script>
    function confirmApproveSponsor(sponsorshipId, companyName) {
        Swal.fire({
            title: 'Setujui Sponsorship?',
            text: `Apakah Anda yakin ingin menyetujui sponsorship dari ${companyName}?`,
            icon: 'question',
            ...
            inputPlaceholder: 'Tambahkan catatan admin...',
            inputAttributes: {
            ...
            if (result.isConfirmed) {
                ...
                form.method = 'POST';
                form.action = `/admin/sponsorships/${sponsorshipId}/approve`;
    ...
    function confirmRejectSponsor(sponsorshipId, companyName) {
        Swal.fire({
            title: 'Tolak Sponsorship?',
            text: `Berikan alasan penolakan sponsorship dari ${companyName}:`,
            icon: 'warning',
            showCancelButton: true,
            ...
            if (result.isConfirmed) {
                ...
                const form = document.createElement('form');
                form.method = 'POST';
                form.action = `/admin/sponsorships/${sponsorshipId}/reject`;
    ...
    function confirmActivateSponsor(sponsorshipId, companyName) {
        Swal.fire({
            title: 'Aktifkan Sponsorship?',
            text: `Apakah Anda yakin ingin mengaktifkan sponsorship dari ${companyName}?`,
            icon: 'question',
            showCancelButton: true,
            ...
            if (result.isConfirmed) {
                ...
                const form = document.createElement('form');
                form.method = 'POST';
                form.action = `/admin/sponsorships/${sponsorshipId}/activate`;
    ...
    function confirmCompleteSponsor(sponsorshipId, companyName) {
        Swal.fire({
            title: 'Selesaikan Sponsorship?',
            text: `Tandai sponsorship dari ${companyName} sebagai selesai?`,
            icon: 'success',
            showCancelButton: true,
            ...
            reverseButtons: true,
            input: 'textarea',
            inputLabel: 'Catatan Penyelesaian (Opsional)',
            inputPlaceholder: 'Tambahkan catatan penyelesaian...',
            inputAttributes: {
            ...
            if (result.isConfirmed) {
                ...
                const form = document.createElement('form');
                form.method = 'POST';
                form.action = `/admin/sponsorships/${sponsorshipId}/complete`;
